...
<!-- Squad Squads — carregados de squads/{id}/agents/{id}.md -->
* `@protocolo`, `/protocolo`, `/protocolo.md` -> `squads/protocolo/agents/protocolo.md`

<!-- Squad protocolo-v2 — ClickUp First, CLI First -->
* `@protocolo-v2`, `/protocolo-v2`, `/protocolo-v2.md` -> `squads/protocolo-v2/agents/protocolo.md`
