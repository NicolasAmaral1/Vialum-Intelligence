...
# Resolve paths relative to this script's location (resources/ folder)
_SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
_RESOURCES_DIR = os.path.join(_SCRIPT_DIR, '..', 'resources')
_TOKEN_PATH = os.path.join(_RESOURCES_DIR, 'token.json')
_CREDENTIALS_PATH = os.path.join(_RESOURCES_DIR, 'credentials.json')
